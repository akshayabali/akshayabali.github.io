(function (global, factory) {
    ...
    function VennDiagram() {
        var width = 600,
            height = innerHeight > 3000 ? 800 : 600,
            padding = 15,
            duration = 1000,
            orientation = Math.PI / 2,
            normalize = true,
...
var sets = [
    {'sets': [0], 'label': 'Bio', 'size': 123, 'label_1': 'Bio', 'tooltip': 'Bio: Engineered biology'} ,
    {'sets': [1], 'label': 'El', 'size': 25, 'label_1': 'El', 'tooltip': 'El: Benchtop electronics or portable commercial electronics'} ,
    {'sets': [2], 'label': 'uF', 'size': 87, 'label_1': 'uF', 'tooltip': 'uF: Controlled liquid flow via microfluidics'} ,
    {'sets': [3], 'label': 'IC', 'size': 74, 'label_1': 'IC', 'tooltip': 'IC: Custom integrated circuits'} ,
    {'sets': [0, 1], 'label': '', 'size': 20, 'label_1': 'Bio, El', 'tooltip': 'Bio, El'} ,
    {'sets': [0, 2], 'label': '', 'size': 54, 'label_1': 'Bio, uf', 'tooltip': 'Bio, uf'} ,
    {'sets': [0, 3], 'label': '', 'size': 55, 'label_1': 'Bio, IC', 'tooltip': 'Bio, IC'} ,
    {'sets': [1, 2], 'label': '', 'size': 11, 'label_1': 'El, uf', 'tooltip': 'El, uf'} ,
    {'sets': [1, 3], 'label': '', 'size': 0, 'label_1': 'El, IC', 'tooltip': 'El, IC'} ,
    {'sets': [2, 3], 'label': '', 'size': 35, 'label_1': 'uf, IC', 'tooltip': 'uf, IC'} ,
    {'sets': [0, 1, 2], 'label': '', 'size': 8, 'label_1': 'Bio, El, uf', 'tooltip': 'Bio, El, uf'} ,
    {'sets': [0, 1, 3], 'label': '', 'size': 0, 'label_1': 'Bio, El, IC', 'tooltip': 'Bio, El, IC'} ,
    {'sets': [0, 2, 3], 'label': '', 'size': 17, 'label_1': 'Bio, uf, IC', 'tooltip': 'Bio, uf, IC'} ,
    {'sets': [1, 2, 3], 'label': '', 'size': 0, 'label_1': 'El, uf, IC', 'tooltip': 'El, uf, IC'} ,
    {'sets': [0, 1, 2, 3], 'label': '', 'size': 0, 'label_1': 'Bio, El, uf, IC', 'tooltip': 'Bio, El, uf, IC'}
];
