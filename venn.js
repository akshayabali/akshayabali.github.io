...
var sets = [
    {'sets': [0], 'label': 'Bio', 'size': 119, 'label_1': 'Bio', 'tooltip': 'Bio: Engineered biology'} ,
    {'sets': [1], 'label': 'El', 'size': 24, 'label_1': 'El', 'tooltip': 'El: Benchtop electronics or portable commercial electronics'} ,
    {'sets': [2], 'label': 'uF', 'size': 83, 'label_1': 'uF', 'tooltip': 'uF: Controlled liquid flow via microfluidics'} ,
    {'sets': [3], 'label': 'IC', 'size': 74, 'label_1': 'IC', 'tooltip': 'IC: Custom integrated circuits'} ,
    {'sets': [0, 1], 'label': '', 'size': 18, 'label_1': 'Bio, El', 'tooltip': 'Bio, El'} ,
    {'sets': [0, 2], 'label': '', 'size': 51, 'label_1': 'Bio, uf', 'tooltip': 'Bio, uf'} ,
    {'sets': [0, 3], 'label': '', 'size': 54, 'label_1': 'Bio, IC', 'tooltip': 'Bio, IC'} ,
    {'sets': [1, 2], 'label': '', 'size': 9, 'label_1': 'El, uf', 'tooltip': 'El, uf'} ,
    {'sets': [1, 3], 'label': '', 'size': 0, 'label_1': 'El, IC', 'tooltip': 'El, IC'} ,
    {'sets': [2, 3], 'label': '', 'size': 35, 'label_1': 'uf, IC', 'tooltip': 'uf, IC'} ,
    {'sets': [0, 1, 2], 'label': '', 'size': 6, 'label_1': 'Bio, El, uf', 'tooltip': 'Bio, El, uf'} ,
