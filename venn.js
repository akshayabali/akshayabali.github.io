...
var sets = [
    ...
    },
    {
        ...
        size: 5,
        label_1: "El",
        tooltip: "El: Benchtop electronics or portable commercial electronics",
    },
    {
        sets: [2],
        label: "uF",
        size: 38,
        label_1: "uF",
        tooltip: "uF: Controlled liquid flow via microfluidics",
    },
    {
        sets: [3],
        label: "IC",
        size: 35,
        label_1: "IC",
        tooltip: "IC: Custom integrated circuits",
    },
    { sets: [0, 1], label: "", size: 3, label_1: "Bio, El", tooltip: "Bio, El" },
    { sets: [0, 2], label: "", size: 19, label_1: "Bio, uf", tooltip: "Bio, uf" },
    { sets: [0, 3], label: "", size: 21, label_1: "Bio, IC", tooltip: "Bio, IC" },
    { sets: [1, 2], label: "", size: 0, label_1: "El, uf", tooltip: "El, uf" },
    { sets: [1, 3], label: "", size: 0, label_1: "El, IC", tooltip: "El, IC" },
    { sets: [2, 3], label: "", size: 6, label_1: "uf, IC", tooltip: "uf, IC" },
    {
        sets: [0, 1, 2],
        label: "",
        size: 1,
    ...
    },
    {
        ...
        label: "",
        size: 0,
        label_1: "Bio, El, uf, IC",
        tooltip: "Bio, El, uf, IC",
    },
];
